...
class BeneficiarioscomedorController extends Controller
{
    ...
    public function index1()
    {
        if(accesoUser([1,2])){
            ...
            return view('beneficiarioscomedor.index',compact('tipouser','modulo','escuelas','semestres','semestresel','contse','semestreNombre','submodulo','activoModulo','permisoModulos','permisoSubModulos'));
        }
        else
        {
