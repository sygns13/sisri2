...
class ProyectoController extends Controller
{
    ...
    public function index1()
    {
        if(accesoUser([1,2])){
            ...
            $modulo="proyectos";
            return view('proyectos.index',compact('tipouser','modulo','escuelas','semestres','semestresel','contse','semestreNombre','submodulo','activoModulo','permisoModulos','permisoSubModulos'));
        }
        else
        {
