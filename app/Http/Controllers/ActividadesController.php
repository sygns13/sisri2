...
class ActividadesController extends Controller
{
    ...
    public function index1()
    {
        if(accesoUser([1,2])){
            ...
            $modulo="actividades";
            return view('actividades.index',compact('tipouser','modulo','semestres','semestresel','contse','semestreNombre','submodulo','activoModulo','permisoModulos','permisoSubModulos'));
        }
        else
        {
