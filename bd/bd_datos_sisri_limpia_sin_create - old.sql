...
CREATE TABLE `actividades` (
  ...
  `actividad` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `descripcion` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `oficinas` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `lugar` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
