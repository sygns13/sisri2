<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Programas de Salud</h3>
      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            <button type="button" class="btn btn-primary" id="btnCrear" @click.prevent="nuevo()"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Nuevo Programa de Salud</button>

            <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'programassalud/exportarExcel?busca='+buscar+'&tipo='+tipogen" data-placement="top" data-toggle="tooltip" title="Descargar Base de Datos Según el Filtro de Búsqueda Empleado"><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Descargar Base de Datos</a>
        ...
        <div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
          <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
            <h3 class="box-title" id="tituloAgregar">Nuevo Programa de Salud</h3>
          </div>
      ...
      <div class="box box-primary" style="border: 1px solid #3c8dbc;">
        <div class="box-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Listado de Programas de Salud</h3>
      ...
      <center>
            ...
            <a v-bind:href="'{{URL::to('atencionsalud')}}/'+programasalud.id"  class="btn btn-success btn-sm"  data-placement="top" data-toggle="tooltip" title="Gestionar Cantidades de Atenciones"><i class="fa fa-bar-chart-o"></i></a>
               ...
               <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editar(programasalud)" data-placement="top" data-toggle="tooltip" title="Editar Programa de Salud"><i class="fa fa-edit"></i></a>
               <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(programasalud)" data-placement="top" data-toggle="tooltip" title="Borrar Programa de Salud"><i class="fa fa-trash"></i></a>
      </center>
             </td>
           </tr>
          ...
          <div class="modal-dialog modal-lg" role="document" id="modaltamanio">
            <div class="modal-content" style="border: 1px solid #3c8dbc;">
              <div class="modal-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
                ...
                <h4 class="modal-title" id="desEditarTitulo" style="font-weight: bold;text-decoration: underline;">EDITAR PROGRAMA DE SALUD</h4>
                ...
                <div class="row">
                  ...
                  <div class="box" id="o" style="border:0px; box-shadow:none;" >
                    <div class="box-header with-border">
                      <h3 class="box-title" id="boxTitulo">Programa de Salud:</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="txtnombreE" name="txtnombreE" placeholder="Nombre" maxlength="500" autofocus v-model="fillprogramassalud.nombre" required>
                        </div>
                      </div>
                    </div>
