    ...
    <template v-if="1==1">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="txtdependenciaE" name="txtdependenciaE" placeholder="Nombre de Dependencia donde Labora el Personal Administrativo"
                maxlength="500" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="fillalumnos.dependencia">
            </div>
