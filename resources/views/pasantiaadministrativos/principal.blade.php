<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Pasantías e Intercambios de Personal Administrativo de la UNASAM</h3>
...
<div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Personal Administrativo de la UNASAM que Realizó Pasantía e Intercambio
    </h3>
  </div>
  @include('pasantiaadministrativos.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  <div class="box-header with-border" style="border: 1px solid #f39c12; background-color: #f39c12; color: white;">
    <h3 class="box-title" id="tituloAgregar">Editar Personal Administrativo de la UNASAM que Realizó Pasantía e Intercambio: @{{ fillalumnos.nombres }} @{{ fillalumnos.apellidopat }} @{{ fillalumnos.apellidomat }}


    </h3>
  </div>

   @include('pasantiaadministrativos.editar')  
      ...
      <div class="box box-primary" style="border: 1px solid #3c8dbc;" >
        ...
        <h3 class="box-title">Listado de Personal Administrativo de la UNASAM que Realizaron Pasantías e Intercambio</h3>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 18%;">Dependencia de Personal</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 13%;">País de Destino</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 15%;">Institución de Destino</th>
      ...
      <center>      
               <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="edit(alumno)" data-placement="top" data-toggle="tooltip" title="Editar Personal Administrativo"><i class="fa fa-edit"></i></a>
               <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(alumno)" data-placement="top" data-toggle="tooltip" title="Borrar Personal Administrativo"><i class="fa fa-trash"></i></a>
      </center>
             </td>
           </tr>
