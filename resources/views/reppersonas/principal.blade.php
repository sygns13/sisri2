        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="border:1px solid #ddd;padding: 5px; width: 29%;">Escuela Profesional</th>
          ...
          <div id="titulo1" style="width:100%;">
            ...
            <div style="width:50px; position: absolute; font-size: 8px; float: right; right: 50px; top:0mm!important;" class="logorep">
              ...
              <h3 class="box-title" style="padding-top:10px;font-size: 12px; text-align: center; font-weight: bold; width: 100%;    line-height: 2;"> 
                <center>REPORTE DE PERSONAS</center>
              </h3>
          </div>
          ...
          <div class="box-body table-responsive" style="width:100%;">
            <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
              <tbody><tr>
                  ...
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 30%;">Apellidos y Nombres</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 15%;">DNI / RUC</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 15%;">Tipo</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 17%;">Escuela Profesional</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 10%;">Código Alumno</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 8%;">Estado</th>
             ...
             <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{key+pagination.from}}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.nombre }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.dni_ruc }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.tipo }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.escuela }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.codigo_alumno }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px; vertical-align: middle;">
                  <center>
               <span  v-if="data.activo=='1'">Activo</span>
               <span  v-if="data.activo=='0'">Inactivo</span>
              </center>
             </td>
