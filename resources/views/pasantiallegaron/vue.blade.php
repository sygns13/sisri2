...
data:{
       ...
       subtitulo: "Personas que Llegaron a la UNASAM",
...
/*
    ...
    */
       ...
       this.fillalumnos.facultad_id=alumno.facultad_id;
   ...
   nuevaProrroga:function (id) {
        ...
        $("#boxTituloProrroga").text('Submódulo: Gestión de Pasantías e Intercambios de Personas que llegaron a la UNASAM');
