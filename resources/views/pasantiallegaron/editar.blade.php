<form method="post" v-on:submit.prevent="update(fillalumnos.id)">
  <div class="box-body" style="font-size: 14px;">
    ...
    <template v-if="1==1">
      ...
      <center>
        <h4>Datos Personales de la Persona que llegó Foraneamente</h4>
      </center>
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          ...
          <label for="txttipoE" class="col-sm-2 control-label">Tipo:*</label>
          <div class="col-sm-3">
              <select class="form-control" id="txttipoE" name="txttipoE" v-model="fillalumnos.tipo">
                <option value="4">Alumno</option>
                <option value="5">Docente</option>
                <option value="6">Personal Administrativo</option>
              </select>
            </div>
      ...
      <div class="col-md-12" style="padding-top: 15px;" >
        <div class="form-group">
            ...
            <label for="txtpaisdestinoE" class="col-sm-2 control-label">País de Procedencia:*</label>
            <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;" >
        <div class="form-group">
            ...
            <label for="txtinstitucionE" class="col-sm-2 control-label">Institución de Procedencia:*</label>
            <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
                ...
                <label for="cbufacultadE" class="col-sm-2 control-label">Facultad de Llegada:*</label>
                <div class="col-sm-10">
                    <select class="form-control" id="cbufacultadE" name="cbufacultadE" v-model="fillalumnos.facultad_id">
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                <div class="form-group">
                    ...
                    <label for="cbuescuelaE" class="col-sm-2 control-label">Escuela de Llegada:*</label>
                    <div class="col-sm-10">
                        <select class="form-control" id="cbuescuelaE" name="cbuescuelaE" v-model="fillalumnos.escuela_id">
                            <option value="0">No adscrito a una Escuela Profesional</option>
  
                          @foreach ($escuelas as $dato)
                          <template v-if="fillalumnos.facultad_id=='{{$dato->facultad_id}}'">
                            <option value="{{$dato->id}}">{{$dato->nombre}}</option>  
                          </template>   
                          @endforeach                   
                        </select>
