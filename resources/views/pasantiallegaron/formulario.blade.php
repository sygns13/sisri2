    ...
    <template v-if="formularioCrear">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          ...
          <div class="col-sm-3">
              <select class="form-control" id="txttipo" name="txttipo" v-model="tipo">
      ...
      <div class="col-md-12" style="padding-top: 15px;" >
        <div class="form-group">
            ...
            <label for="txtpaisdestino" class="col-sm-2 control-label">País de Procedencia:*</label>
            <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;" >
        <div class="form-group">
            ...
            <label for="txtinstitucion" class="col-sm-2 control-label">Institución de Procedencia:*</label>
            <div class="col-sm-10">
          ...
          <div class="col-md-12" style="padding-top: 15px;">
            <div class="form-group">
                ...
                <label for="cbufacultad" class="col-sm-2 control-label">Facultad de Llegada:*</label>
                <div class="col-sm-10">
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                <div class="form-group">
                    ...
                    <label for="cbuescuela" class="col-sm-2 control-label">Escuela de Llegada:*</label>
                    <div class="col-sm-10">
