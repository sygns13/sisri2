<form v-on:submit.prevent="create">
  <div class="box-body" style="font-size: 14px;">
    ...
    <template v-if="formularioCrear">
      ...
      <center>
        <h4>Datos Personales del Docente Investigador</h4>
      </center>
      ...
      <div class="col-md-12" style="padding-top: 15px;">
          ...
          <div class="col-md-12" style="padding-top: 15px;">
              <div class="form-group">
                ...
                <label for="cbuclasificacion" class="col-sm-2 control-label">Clasificación:*</label>
  
                <div class="col-sm-3">
                  <select class="form-control" id="cbuclasificacion" name="cbuclasificacion" v-model="clasificacion">
