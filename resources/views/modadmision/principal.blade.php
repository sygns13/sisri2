<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Modalidades de Admisión</h3>
      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            <button type="button" class="btn btn-primary" id="btnCrear" @click.prevent="nuevo()"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Nueva Modalidad de Admisión</button>

            <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'modalidadadmision/exportarExcel?busca='+buscar" data-placement="top" data-toggle="tooltip" title="Descargar Base de Datos Según el Filtro de Semestre y Búsqueda Empleado"><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Descargar Base de Datos</a>
        ...
        <div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
          <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
            <h3 class="box-title" id="tituloAgregar">Nueva Modalidad de Admisión</h3>
          </div>
           ...
           <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="txtnom" name="txtnom" placeholder="Nombre" maxlength="500" autofocus v-model="nombre" >
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12" >
              ...
              <div class="form-group" style="padding-top: 15px;">
                ...
                <div class="col-sm-8">
                  <textarea name="txtdesc" id="txtdesc"rows="6" class="form-control" v-model="descripcion" placeholder="Descripción"></textarea>
                </div>
              </div>
            </div>
      ...
      <div class="box box-primary" style="border: 1px solid #3c8dbc;">
        <div class="box-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Listado de Modalidades de Admisión</h3>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="border:1px solid #ddd;padding: 5px; width: 30%;">Nombre</th>
              <th style="border:1px solid #ddd;padding: 5px; width: 40%;">Descripción</th>
      ...
      <form method="post" v-on:submit.prevent="update(fillmodadmision.id)">
          ...
          <div class="modal-dialog modal-lg" role="document" id="modaltamanio">
            <div class="modal-content" style="border: 1px solid #3c8dbc;">
              <div class="modal-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
                ...
                <h4 class="modal-title" id="desEditarTitulo" style="font-weight: bold;text-decoration: underline;">EDITAR MODALIDAD DE ADMISIÓN</h4>
                  ...
                  <div class="box" id="o" style="border:0px; box-shadow:none;" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input type="text" class="form-control" id="txtnomE" name="txtnomE" placeholder="Nombre" maxlength="500" autofocus v-model="fillmodadmision.nombre" >
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-12" >
                            ...
                            <div class="form-group" style="padding-top: 15px;">
                              ...
                              <div class="col-sm-8">
                                <textarea name="txtdescE" id="txtdescE"rows="6" class="form-control" v-model="fillmodadmision.descripcion" placeholder="Descripción"></textarea>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-md-12" style="padding-top: 15px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control" id="cbuestadoE" name="cbuestadoE" v-model="fillmodadmision.activo">
                            <option value="1">Activado</option>
                            <option value="0">Desactivado</option>
                          </select>
                        </div>
