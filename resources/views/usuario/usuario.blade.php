  ...
  <div class="box-body table-responsive">
    <table class="table table-hover table-bordered" >
      <tbody><tr>
        ...
        <th style="padding: 5px; width: 16%;">Tipo de Persona</th>
        <th style="padding: 5px; width: 9%;">Usuario</th> 
        <th style="padding: 5px; width: 9%;">Entidad</th> 
        <th style="padding: 5px; width: 6%;">Estado</th>
        <th style="padding: 5px; width: 13%;">Gestión</th>
      </tr>
      <tr v-for="usuario, key in usuarios">
        <td style="font-size: 14px; padding: 5px;">@{{key+pagination.from}}</td>
        <td style="font-size: 14px; padding: 5px;">@{{ usuario.tipouser }}</td>
        <td style="font-size: 14px; padding: 5px;">@{{ usuario.nombre }}</td>
        <td style="font-size: 14px; padding: 5px;">@{{ usuario.dni }}</td>
        <td style="font-size: 14px; padding: 5px;">@{{ usuario.tipoPer }}</td>
        <td style="font-size: 14px; padding: 5px;">@{{ usuario.username }}</td>
        <td style="font-size: 14px; padding: 5px;">@{{ usuario.entidad }}</td>
