<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Alumnos Matriculados de Postgrado</h3>
            ...
            <template v-if="contse!='0'">
                    ...
                    <div class="col-sm-2">
                      ...
                      @endif
                        ...
                        <div class="col-sm-12" style="padding-top:15px;">
                            <a download="Instructivo_Carga_Data_Alumnos_Postgrado.xlsx" type="button" class="btn btn-info" id="btnDescargarPlantilla" href="{{URL::to('instructivo/Instructivo_Carga_Data_Alumnos_Postgrado.xlsx')}}" data-placement="top" data-toggle="tooltip" title="Descargar Instructivo Para Importar Data"><i class="fa fa-search" aria-hidden="true" ></i> Ver Instructivo Para Carga de Data</a>
...
<div class="box box-success" v-if="divNuevoImporte">
  <div class="box-header with-border" >
    <h3 class="box-title" id="tituloAgregarImporte">Importar Datos en Lote Alumnos de Postgrado - Formato EXCEL</h3>
  </div>
...
<div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Alumno Matriculado de Postgrado
    </h3>
  </div>
  @include('alumnospostgrado.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('alumnospostgrado.editar')  
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 12%;">Grado de Estudios</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 19%;">Denominación del Grado y Mensión</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 13%;">Promedio Ponderado</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 14%;">Escala de Pagos</th>
              @if($activoModulo == 1 || $activoModulo == 3 || accesoUser([1]))
            ...
            <tr v-for="alumno, key in alumnos">
              ...
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">
                  <template v-if="parseInt(alumno.grado)==3">Maestría</template>
                  <template v-if="parseInt(alumno.grado)==4">Doctorado</template>
              </td>
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">@{{ alumno.nombreGrado }}</td>
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">@{{ alumno.promedioPonderado }}</td>
            <td style="border:1px solid #ddd;font-size: 11px; padding: 5px; vertical-align: middle;">@{{alumno.escalaPagodesc}}</td>
            @if($activoModulo == 1 || $activoModulo == 3 || accesoUser([1]))
             <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">
      <center>      
