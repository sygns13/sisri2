...
/*
   ...
   edit:function (alumno) {
       ...
       this.fillalumnos.maximogrado=alumno.maximogrado;
   ...
   nuevaExportación:function () {
        ...
        $("#boxTituloProrroga").text('Submódulo: Gestión de Matriculados Postgrado');
