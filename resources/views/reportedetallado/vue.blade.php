...
methods: {
   ...
   getInfoInicial:function(){
    ...
    cambiarlocal:function(){
        ...
        this.mostrartabla=false;
        var idLocal=this.local;

        this.nombrelocal=$("#cbuLocal option:selected").text();

          this.entidad=0;

          //this.cambioDep();

          if(parseInt(idLocal)>0){
          var url = 'reportedetallado/cambiarlocal/'+idLocal+'';
                            axios.get(url).then(response=>{
    ...
    cambiarentidad:function(){
        this.nombreentidad=$("#cbuEntidad option:selected").text();
        this.mostrartabla=false;
    },

    cambiarcategoria:function(){
        var idCategoria=this.categoria;
        this.mostrartabla=false;

        this.nombrecategoria=$("#cbuCategoria option:selected").text();
          ...
          var url = 'reportedetallado/cambiarcategoria/'+idCategoria+'';
                            axios.get(url).then(response=>{
    ...
    cambiarrubro:function(){
        var idRubro=this.rubro;
        this.mostrartabla=false;
        this.nombrerubro=$("#cbuRubro option:selected").text();

          this.precio=0;

          //this.cambioDep();

          if(parseInt(idRubro)>0){
          var url = 'reportedetallado/cambiarrubro/'+idRubro+'';
                            axios.get(url).then(response=>{
    ...
    cambiarprecio:function(){
        this.nombreprecio=$("#cbuEntidad option:selected").text();
        this.mostrartabla=false;
    },
...
//  $("body").css({ 'height' : '2100px'});
   ...
   var url="reportedetallado/buscarDatos";
   ...
   axios.post(url,{cbufec:this.cbufec, fechai:this.fechai, fechaf:this.fechaf, anio:this.anio, mes:this.mes , fecha0:this.fecha0, tipo:this.tipo, cajero:this.cajero, idpersona:this.fillPersona.id, local:this.local, categoria:this.categoria, entidad:this.entidad, rubro:this.rubro, precio:this.precio}).then(response=>{
...
imprimirReporte(){
    ...
    {
    var url="reportedetallado/buscarDatosImp";
   ...
   borrarrecibo:function (recibo) {
        ...
        swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'reportegeneral/'+recibo.id;
   ...
   bajarecibo:function (recibo) {
    ...
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'reportegeneral/altabaja/'+recibo.id+'/3';
   ...
   altarecibo:function (recibo) {
    ...
    swal.fire({
            ...
            if (result.value) {
                ...
                var url = 'reportegeneral/altabaja/'+recibo.id+'/2';
                       axios.get(url).then(response=>{//eliminamos
