<div class="box box-primary panel-group">
    ...
    <h3 class="box-title">Reportes Detallados de Recibos Emitidos</h3>
...
<option v-for="yea, key in years" v:bind-value="yea.year">@{{yea.year}}</option>
  ...
  <div class="box box-primary" style="border: 1px solid #3c8dbc;" v-if="mostrartabla">
    ...
    <h5 v-if="cbufec==3"><b><div style="display:inline-block; width:150px;">Reporte Desde:</div> @{{fechai | fecha}} Hasta: @{{fechaf | fecha}}</b></h5>
      ...
      <div class="col-md-6">
        <h5 v-if="tipo==0"><b><div style="display:inline-block; width:150px;">Tipo:</div> Todos (Pagados y Extornos)</b></h5>
        <h5 v-if="tipo==1"><b><div style="display:inline-block; width:150px;">Tipo:</div> Solo Pagados</b></h5>
        <h5 v-if="tipo==2"><b><div style="display:inline-block; width:150px;">Tipo:</div> Solo Extornos</b></h5>
      </div>  
      
      <div class="col-md-6">
      <h5 v-if="tipo==0 | tipo==1"><b><div style="display:inline-block; width:150px;">Monto Total Cobrado:</div> S/ @{{parseFloat(totalcobrado).toFixed(2)}}</b></h5>
        <h5 v-if="tipo==0 | tipo==2"><b><div style="display:inline-block; width:150px;">Monto Total Extornos:</div> S/ @{{parseFloat(totalextornado).toFixed(2)}}</b></h5>
      </div>  
