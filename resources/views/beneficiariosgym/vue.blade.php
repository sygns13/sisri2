...
data:{
       ...
       subtitulo: "Alumnos Beneficiarios del Gimnasio Universitario",
...
methods: {
   ...
   getAlumno: function (page) {
       ...
       var url = 'benefgym?page='+page+'&busca='+busca+'&semestre_id='+this.semestre_id;
...
/*
   ...
   borrar:function (alumno) {
        ...
        swal.fire({
             title: '¿Estás seguro?',
             text: "¿Desea eliminar el Alumno Beneficiario del Gimnasio Seleccionado? -- Nota: este proceso no se podrá revertir.",
             type: 'info',
...
/*
   ...
   nuevaProrroga:function (id) {
        ...
        $("#boxTituloProrroga").text('Submódulo: Gestión de Beneficiarios del Gimnasio Universitario');
