      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            ...
            <div class="col-sm-12" style="padding-top:15px;">
              ...
              <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'postulantesR/exportarExcel?busca='+buscar+'&semestre_id='+semestre_id+'&tipo='+tipoGen" data-placement="top" data-toggle="tooltip" title="Descargar Base de Datos Según el Filtro de Semestre y Búsqueda Empleado"><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Descargar Base de Datos</a>
  
  
                <a download="Postulantes_Postgrado_Plantilla_Carga_Datos.xlsx" type="button" class="btn btn-warning" id="btnDescargarPlantilla" href="{{URL::to('plantillas/Postulantes_Postgrado_Plantilla_Carga_Datos.xlsx')}}" data-placement="top" data-toggle="tooltip" title="Descargar Plantilla de Carga de Datos"><i class="fa fa-file-text" aria-hidden="true" ></i> Descargar Plantilla Para Carga de Data</a>
              ...
              <div class="col-sm-12" style="padding-top:15px;">
                  ...
                  <a download="Instructivo_Carga_Data_Postulantes_Postgrado.xlsx" type="button" class="btn btn-info" id="btnDescargarPlantilla" href="{{URL::to('instructivo/Instructivo_Carga_Data_Postulantes_Postgrado.xlsx')}}" data-placement="top" data-toggle="tooltip" title="Descargar Instructivo Para Importar Data"><i class="fa fa-search" aria-hidden="true" ></i> Ver Instructivo Para Carga de Data</a>
...
<div class="box box-success" v-if="divNuevoImporte">
  <div class="box-header with-border" >
    <h3 class="box-title" id="tituloAgregarImporte">Importar Datos en Lote Postulantes de Postgrado - Formato EXCEL</h3>
  </div>
