<div class="box box-primary panel-group">
      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            ...
            <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'beneficiarioscomedor/exportarExcel?busca='+buscar+'&semestre_id='+semestre_id" data-placement="top" data-toggle="tooltip" title="Descargar Base de Datos Según el Filtro de Semestre y Búsqueda Empleado"><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Descargar Base de Datos</a>
