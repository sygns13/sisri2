<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Eventos Culturales</h3>
      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            ...
            <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'eventosculturales/exportarExcel?busca='+buscar+'&semestre_id='+semestre_id" data-placement="top" data-toggle="tooltip" title="Descargar Base de Datos Según el Filtro de Semestre y Búsqueda Empleado"><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Descargar Base de Datos</a>
...
<div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Evento Cultural
    </h3>
  </div>
...
<div class="box box-warning" v-if="divEdit">
  <div class="box-header with-border" style="border: 1px solid #f39c12; background-color: #f39c12; color: white;">
    <h3 class="box-title" id="tituloAgregar">Editar  Evento Cultural: @{{ fillevento.nombre }}
  ...
  @include('eventos.editar')  
      ...
      <div class="box box-primary" style="border: 1px solid #3c8dbc;" v-if="semestre_id!='0'">
        ...
        <h3 class="box-title">Listado de Eventos Culturales en el Semestre: @{{semestreNombre}}</h3>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 10%;">Fecha de Inicio</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 10%;">Fecha de Término</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 16%;">Lugar de Presentación</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 16%;">Entidad Asociada</th>
              @if($activoModulo == 1 || $activoModulo == 3 || accesoUser([1]))
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 12%;">Gestión</th>
              @endif
            </tr>
      ...
      <center>      
          ...
          <a v-bind:href="'{{URL::to('talleresparticipantes')}}/'+evento.id"  class="btn btn-success btn-sm"  data-placement="top" data-toggle="tooltip" title="Gestionar Talleres Participantes"><i class="fa fa-users"></i></a>


               <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="edit(evento)" data-placement="top" data-toggle="tooltip" title="Editar Evento Cultural"><i class="fa fa-edit"></i></a>
               <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(evento)" data-placement="top" data-toggle="tooltip" title="Borrar Evento Cultural"><i class="fa fa-trash"></i></a>
      </center>
             </td>
             @endif
           </tr>
