...
data:{
       ...
       subtitulo: "Alumnos Beneficiarios de Talleres Deportivos",
   ...
   fillalumnos:{'tipodoc':'', 'doc':'', 'nombres':'','apellidopat':'','apellidomat':'','genero':'','estadocivil':'','fechanac':'','esdiscapacitado':'','discapacidad':'','pais':'','departamento':'','provincia':'','distrito':'','direccion':'','email':'','telefono':'','id':'','codigo':'','escuela_id':'','semestre_id':'', 'persona_id':'','observaciones':'','disciplina':''},
...
methods: {
   ...
   getAlumno: function (page) {
       ...
       var url = 'beneftalldep?page='+page+'&busca='+busca+'&semestre_id='+this.semestre_id;
...
/*
   ...
   borrar:function (alumno) {
        ...
        swal.fire({
             title: '¿Estás seguro?',
             text: "¿Desea eliminar el Alumno Beneficiario de Talleres Deportivos? -- Nota: este proceso no se podrá revertir.",
             type: 'info',
            ...
            if (result.value) {
                ...
                var url = 'beneftalldep/'+alumno.id;
...
/*
   ...
   edit:function (alumno) {
       ...
       this.fillalumnos.disciplina=alumno.disciplina;
   ...
   update:function (id) {
       ...
       axios.put(url, this.fillalumnos).then(response=>{
           ...
           if(response.data.result=='1'){   
           this.getAlumno(this.thispage);
           this.fillalumnos={'tipodoc':'', 'doc':'', 'nombres':'','apellidopat':'','apellidomat':'','genero':'','estadocivil':'','fechanac':'','esdiscapacitado':'','discapacidad':'','pais':'','departamento':'','provincia':'','distrito':'','direccion':'','email':'','telefono':'','id':'','codigo':'','escuela_id':'','semestre_id':'', 'persona_id':'','observaciones':'','disciplina':''};
           this.errors=[];
   ...
   nuevaProrroga:function (id) {
        ...
        $("#boxTituloProrroga").text('Submódulo: Gestión de Beneficiarios de Talleres Deportivos');
