      ...
      <center>
        ...
        <div class="col-md-12" style="padding-top: 15px;">
          ...
          <div class="form-group">
              ...
              <label for="txtdisciplinaE" class="col-sm-2 control-label">Disciplina Deportiva:</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="txtdisciplinaE" name="txtdisciplinaE" placeholder="Nombre de Disciplina Deportiva"
                  maxlength="500" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="fillalumnos.disciplina">
              </div>
