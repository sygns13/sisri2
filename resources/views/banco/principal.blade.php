<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Bancos</h3>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="border:1px solid #ddd;padding: 5px; width: 75%;">Nombre</th>
            ...
            <tr v-for="banco, key in bancos">
              <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">@{{key+pagination.from}}</td>
              <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">@{{ banco.nombre }}</td>
              <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
                  <center>
               <span class="label label-success" v-if="banco.activo=='1'">Activo</span>
               <span class="label label-warning" v-if="banco.activo=='0'">Inactivo</span>
              </center>
             </td>
             <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
      <center>
               <a href="#" v-if="banco.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="bajabanco(banco)" data-placement="top" data-toggle="tooltip" title="Desactivar Banco"><i class="fa fa-arrow-circle-down"></i></a>
      
               <a href="#" v-if="banco.activo=='0'" class="btn btn-success btn-sm" v-on:click.prevent="altabanco(banco)" data-placement="top" data-toggle="tooltip" title="Activar Banco"><i class="fa fa-check-circle"></i></a>
               ...
               <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrarbanco(banco)" data-placement="top" data-toggle="tooltip" title="Borrar Banco"><i class="fa fa-trash"></i></a>
      </center>
             </td>
           </tr>
