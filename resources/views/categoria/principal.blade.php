<div class="box box-primary panel-group">
      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            <button type="button" class="btn btn-primary" id="btnCrear" @click.prevent="nuevo()"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Nueva Categoría</button>
          </div>
        ...
        <div class="box box-success" v-if="divNuevo" style="border: 1px solid #00a65a;">
          <div class="box-header with-border" style="border: 1px solid #00a65a;background-color: #00a65a; color: white;">
            <h3 class="box-title" id="tituloAgregar">Nueva Categoría</h3>
          </div>
           ...
           <div class="box-body">
            ...
            <div class="col-md-12" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="txtdesc" name="txtdesc" placeholder="Descripción" maxlength="500" autofocus v-model="newCategoria" >
                </div>
              </div>
            </div>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="border:1px solid #ddd;padding: 5px; width: 60%;">Descripción</th>
              <th style="border:1px solid #ddd;padding: 5px; width: 15%;">Código</th>
            ...
            <tr v-for="categoria, key in categorias">
              ...
              <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">@{{ categoria.descripcion }}</td>
              <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">@{{ categoria.code }}</td>
              <td style="border:1px solid #ddd;font-size: 14px; padding: 5px; vertical-align: middle;">
                  <center>
               <span class="label label-success" v-if="categoria.activo=='1'">Activo</span>
               <span class="label label-warning" v-if="categoria.activo=='0'">Inactivo</span>
              </center>
             </td>
             <td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
      <center>
               <a href="#" v-if="categoria.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="bajacategoria(categoria)" data-placement="top" data-toggle="tooltip" title="Desactivar Categoria"><i class="fa fa-arrow-circle-down"></i></a>
      
               <a href="#" v-if="categoria.activo=='0'" class="btn btn-success btn-sm" v-on:click.prevent="altacategoria(categoria)" data-placement="top" data-toggle="tooltip" title="Activar Categoria"><i class="fa fa-check-circle"></i></a>
      
      
               <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editcategoria(categoria)" data-placement="top" data-toggle="tooltip" title="Editar Categoria"><i class="fa fa-edit"></i></a>

               <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrarcategoria(categoria)" data-placement="top" data-toggle="tooltip" title="Borrar Categoria"><i class="fa fa-trash"></i></a>
      </center>
             </td>
           </tr>
          ...
          <div class="modal-dialog modal-lg" role="document" id="modaltamanio">
            <div class="modal-content" style="border: 1px solid #3c8dbc;">
              <div class="modal-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
                ...
                <h4 class="modal-title" id="desEditarTitulo" style="font-weight: bold;text-decoration: underline;">EDITAR CATEGORÍA</h4>
                ...
                <div class="row">
                  ...
                  <div class="box" id="o" style="border:0px; box-shadow:none;" >
                    <div class="box-header with-border">
                      <h3 class="box-title" id="boxTitulo">Categoría:</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="txtdescE" name="txtdescE" placeholder="Descripción" maxlength="500" autofocus v-model="fillCategoria.descripcion" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12" >
                      ...
                      <div class="form-group" style="padding-top: 15px;">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="txtcodE" name="txtcodE" placeholder="Código" required maxlength="45"  v-model="fillCategoria.code">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12" style="padding-top: 15px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control" id="cbuestadoE" name="cbuestadoE" v-model="fillCategoria.activo">
                            <option value="1">Activado</option>
                            <option value="0">Desactivado</option>
                          </select>
                        </div>
