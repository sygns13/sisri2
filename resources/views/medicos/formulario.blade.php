    ...
    <template v-if="formularioCrear">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
          <div class="form-group">
              ...
              <label for="txtespecialidad" class="col-sm-2 control-label">Especialidad:</label>
              <div class="col-sm-10">
            ...
            <div class="col-md-12" style="padding-top: 15px;">
              <div class="form-group">
                ...
                <label for="txtfechaingreso" class="col-sm-2 control-label">Fecha de Ingreso:*</label>
                <div class="col-sm-2">
                ...
                <label for="txtfechainiciocontrato" class="col-sm-2 control-label">Fecha de Inicio de Contrato:*</label>
                <div class="col-sm-2">
                    <input type="date" class="form-control" id="txtfechainiciocontrato" name="txtfechainiciocontrato" placeholder="dd/mm/aaaa"
                    maxlength="10" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="fechainiciocontrato">
                </div>

                <label for="txtfechafincontrato" class="col-sm-2 control-label">Fecha de Fin de Contrato:*</label>
                <div class="col-sm-2">
                    <input type="date" class="form-control" id="txtfechafincontrato" name="txtfechafincontrato" placeholder="dd/mm/aaaa"
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                <div class="form-group">
                  ...
                  <label for="cbuacargo" class="col-sm-2 control-label">Se encuentra a cargo del Programa de Salud:*</label>
                  <div class="col-sm-2">
                      <select class="form-control" id="cbuacargo" name="cbuacargo" v-model="acargo">
                        <option value="0">No</option>
                        <option value="1">Si</option>
                      </select>
                    </div>
...
<div class="col-md-12" style="padding-top: 15px;">
    <div class="form-group">
      ...
      <label for="cbutipo" class="col-sm-2 control-label">Tipo de Personal de Campaña:*</label>
      <div class="col-sm-2">
    ...
    <div class="form-group">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
          <div class="form-group">
            ...
            <label for="cbuacargo" class="col-sm-2 control-label">Se encuentra a cargo de la Campaña de Salud:*</label>
            <div class="col-sm-2">
                <select class="form-control" id="cbuacargo" name="cbuacargo" v-model="acargo">
                  <option value="0">No</option>
                  <option value="1">Si</option>
