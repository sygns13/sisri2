<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          ...
          <a style="float: right;" type="button" class="btn btn-default" href="{{URL::to('eventosculturales')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
          Volver a Eventos Culturales</a>
 ...
 @include('talleresparticipantes.formulario') 
</div>
...
<div class="box box-warning" v-if="divEdit">
 ...
 @include('talleresparticipantes.editar')
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 30%;">Taller</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 16%;">Fecha</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 10%;">Cantidad de Participantes</th>
            ...
            <tr v-for="taller, key in talleres">
              ...
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">@{{ taller.fecha | fecha }}</td>
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">@{{ taller.participantes }}</td>
 
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">@{{ taller.observaciones }}</td>
              <td style="border:1px solid #ddd;font-size: 11px; padding: 5px;">
                  <center>      
                           <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="edit(taller)" data-placement="top" data-toggle="tooltip" title="Editar Registro"><i class="fa fa-edit"></i></a>
                           <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(taller)" data-placement="top" data-toggle="tooltip" title="Borrar Registro"><i class="fa fa-trash"></i></a>
                  </center>
                         </td>
