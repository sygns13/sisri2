<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Reporte de Rubros</h3>
          ...
          <div class="box-body table-responsive" style="width:100%;">
            <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
              <tbody><tr>
                  ...
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 45%;">Descripción</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 15%;">Código</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 30%;">Categoría</th>
              ...
              <td style="font-size:12px;border:1px solid #000000; padding: 5px;">@{{ data.categoria }}</td>
