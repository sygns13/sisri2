<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Reporte de Conceptos de Pago</h3>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="border:1px solid #ddd;padding: 5px; width: 27%;">Descripción</th>
              <th style="border:1px solid #ddd;padding: 5px; width: 10%;">Código</th>
              <th style="border:1px solid #ddd;padding: 5px; width: 8%;">Monto</th>
              <th style="border:1px solid #ddd;padding: 5px; width: 25%;">Entidad</th>
          ...
          <div id="titulo1" style="width:100%;">
            ...
            <div style="width:50px; position: absolute; font-size: 8px; float: right; right: 50px; top:0mm!important;" class="logorep">
              ...
              <h3 class="box-title" style="padding-top:10px;font-size: 12px; text-align: center; font-weight: bold; width: 100%;    line-height: 2;"> 
                <center>REPORTE DE CONCEPTOS DE PAGO</center>
              </h3>
          </div>
          ...
          <div class="box-body table-responsive" style="width:100%;">
            <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
              <tbody><tr>
                  ...
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 27%;">Descripción</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 10%;">Código</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 8%;">Monto</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 25%;">Entidad</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 20%;">Rubro</th>
                  <th style="font-size:12px;border:1px solid #000000;padding: 5px; width: 5%;">Estado</th>
    
              </tr>
              <tr v-for="data, key in dataimp">
   
                 <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{key+pagination.from}}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.descripcion }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.codigo }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;text-align:right;">S/. @{{ parseFloat(data.monto).toFixed(2) }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.entidad }}</td>
              <td style="font-size:10px;border:1px solid #000000; padding: 2px;">@{{ data.rubro }}</td>
