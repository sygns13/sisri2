 ...
 @if(accesoUser([1]))
    ...
    <li class="treeview" v-bind:class="classMenu6">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="{{URL::to('condicion')}}"><i class='fa fa-gg'></i> Condición Socioeconómica del Estudiante</a></li>
    ...
    @if(accesoUser([1]))
      <li class="treeview" v-bind:class="classMenu8">
          <a href="#"><i class='fa fa-empire'></i> <span>Bioseguridad y Defensa Civil</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
    ...
    <li class="treeview" v-bind:class="classMenu9">
        ...
        <ul class="treeview-menu">
                @if(accesoUser([1]))
                  ...
                  <li><a href="{{URL::to('programacion')}}"><i class='fa fa-gg'></i> Gestión y Programación de Módulos</a></li>
                @endif
