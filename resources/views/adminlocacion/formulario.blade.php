      ...
      <div class="col-md-12" style="padding-top: 15px;">
          ...
          <div class="col-md-12" style="padding-top: 15px;">
              <div class="form-group">
                ...
                <label for="txtcondicion" class="col-sm-2 control-label">Condición Laboral:*</label>
                <div class="col-sm-4">
                  ...
                  <label for="txtregimen" class="col-sm-2 control-label">Régimen Laboral:*</label>
                  <div class="col-sm-4">
          ...
          <div class="col-md-12" style="padding-top: 15px;">
            ...
            <div class="col-md-12" style="padding-top: 15px;" v-if="grado!='0'">
              ...
              <div class="form-group">
                ...
                <label for="txtfechacontrato" class="col-sm-2 control-label">Fecha de Inicio de Contrato:*</label>
                <div class="col-sm-2">
                ...
                <label for="txtfechafinalContrato" class="col-sm-2 control-label">Fecha Final de Contrato:*</label>
                <div class="col-sm-2">
