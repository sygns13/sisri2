...
/*
   ...
   descargarPlantilla:function(){
    //window.location="adminlocaservs/imprimirExcel/"+buscar+"/"+fech+"/"+fec1+"/"+fec2+"/"+tipoP+"";
    window.location="adminlocaservs/imprimirExcel/"+3;
   },
}
});
</script>