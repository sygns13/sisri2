...
methods: {
    ...
    buscarRecibo:function(){
        var url='auditarrecibo';
       $("#guardar").attr('disabled', true);
       $("#btnCancelF").attr('disabled', true);
      // $("#btnClose").attr('disabled', true);
       this.divloaderNuevo=true;
       //$(".form-control").css("border","1px solid #d2d6de");

       this.mostrarRecibo=false;
       axios.post(url,{codRbo:this.codRbo}).then(response=>{
           //console.log(response.data);

           $("#guardar").removeAttr("disabled");
           $("#btnCancelF").removeAttr("disabled");
           ...
           if(String(response.data.result)=='1'){
            ...
            this.procesosRecibo= response.data.procesosRecibo;
            this.detalleRecibos= response.data.detalleRecibos;
            this.detalleProcesos= response.data.detalleProcesos;
