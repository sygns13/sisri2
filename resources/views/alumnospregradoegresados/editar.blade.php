        ...
        <div class="col-md-12" style="padding-top: 15px;">
            ...
            <div class="col-sm-3">
              ...
              <label for="cbuprimersemestreE" class="col-sm-2 control-label">Primer Semestre de Matrícula:*</label>
                ...
                <div class="col-md-12" style="padding-top: 15px;">
                    <div class="form-group">
                        <label for="cbuegresadoOtraCarreraE" class="col-sm-2 control-label">Es egresado de Otra Carrera:*</label>
                        <div class="col-sm-2">
                ...
                <div class="col-md-12" style="padding-top: 15px;" v-if="parseInt(fillalumnos.egresadoOtraCarrera)!=0">
                    <div class="form-group">
                        ...
                        <label for="txtotracarreraE" class="col-sm-3 control-label">Ingrese su Otra Carrera de Egreso:*</label>
                        <div class="col-sm-9">
                  ...
                  <div class="col-md-12" style="padding-top: 15px;">
                      <div class="form-group">
                          <label for="cbutituladootracarreraE" class="col-sm-2 control-label">Es Titulado de Otra Carrera:*</label>
                          <div class="col-sm-2">
                  ...
                  <div class="col-md-12" style="padding-top: 15px;" v-if="parseInt(fillalumnos.tituladoOtraCarrera)!=0">
                      <div class="form-group">
                          ...
                          <label for="txttitulootracarreraE" class="col-sm-3 control-label">Ingrese el Título de su Otra Carrera:*</label>
                          <div class="col-sm-9">
