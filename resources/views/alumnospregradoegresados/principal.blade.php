<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Alumnos Egresados de Pregrado</h3>
      ...
      <div class="box-body" style="border: 1px solid #3c8dbc;">
          <div class="form-group form-primary">
            ...
            <label for="cbusemestre" class="col-sm-1 control-label" style="width: auto;">Semestre de Egreso:*</label>
                    <div class="col-sm-2">
            ...
            <div class="col-sm-12" style="padding-top:15px;">
              ...
              <a type="button" class="btn btn-success" id="btnDescargarPlantilla" v-bind:href="'alumnopregradoR/exportarExcel2?busca='+buscar+'&semestre_id='+semestre_id+'&tipo='+tipoGeneral" data-placement="top" data-toggle="tooltip" title="Descargar Base de Datos Según el Filtro de Semestre y Búsqueda Empleado"><i class="fa fa-file-excel-o" aria-hidden="true" ></i> Descargar Base de Datos</a>
  
                <a download="Egresados_Pregrado_Plantilla_Carga_Datos.xlsx" type="button" class="btn btn-warning" id="btnDescargarPlantilla" href="{{URL::to('plantillas/Egresados_Pregrado_Plantilla_Carga_Datos.xlsx')}}" data-placement="top" data-toggle="tooltip" title="Descargar Plantilla de Carga de Datos"><i class="fa fa-file-text" aria-hidden="true" ></i> Descargar Plantilla Para Carga de Data</a>
              ...
              <div class="col-sm-12" style="padding-top:15px;">
                  ...
                  <a download="Instructivo_Carga_Data_Egresados_Pregrado.xlsx" type="button" class="btn btn-info" id="btnDescargarPlantilla" href="{{URL::to('instructivo/Instructivo_Carga_Data_Egresados_Pregrado.xlsx')}}" data-placement="top" data-toggle="tooltip" title="Descargar Instructivo Para Importar Data"><i class="fa fa-search" aria-hidden="true" ></i> Ver Instructivo Para Carga de Data</a>
...
<div class="box box-success" v-if="divNuevoImporte">
  <div class="box-header with-border" >
    <h3 class="box-title" id="tituloAgregarImporte">Importar Datos en Lote Alumnos Egresados de Pregrado - Formato EXCEL</h3>
  </div>
...
<div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Alumno Egresado de Pregrado
    </h3>
  </div>
  @include('alumnospregradoegresados.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('alumnospregradoegresados.editar')  
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
              ...
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 17%;">Facultad</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 20%;">Escuela Profesional</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 12%;">Promedio Ponderado</th>
              <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 13%;">Primer Semestre de Matrícula</th>
