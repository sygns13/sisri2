...
{{-- <div class="box box-warning" v-if="divEdit">
  <div class="box-header with-border" style="border: 1px solid #f39c12; background-color: #f39c12; color: white;">
    <h3 class="box-title" id="tituloAgregar">Editar Docente: @{{ fillpostulantes.nombres }} @{{ fillpostulantes.apellidopat }} @{{ fillpostulantes.apellidomat }}
 ...
 --}}
      ...
      <center>      
               <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="edit(docente)" data-placement="top" data-toggle="tooltip" title="Editar Modalidad de Admisión"><i class="fa fa-edit"></i></a>
               <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(docente)" data-placement="top" data-toggle="tooltip" title="Borrar Modalidad de Admisión"><i class="fa fa-trash"></i></a>
      </center>
             </td>
           </tr>
