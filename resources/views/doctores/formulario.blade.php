    ...
    <template v-if="formularioCrear">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
          <div class="form-group">
              ...
              <label for="txtgrado" class="col-sm-2 control-label">Nombre del Grado:</label>
              <div class="col-sm-10">
            ...
            <div class="col-md-12" style="padding-top: 15px;">
              <div class="form-group">
                ...
                <label for="txtfechaegreso" class="col-sm-2 control-label">Fecha de Egreso:*</label>
                <div class="col-sm-2">
                ...
                <label for="cbuidioma" class="col-sm-1 control-label">Idioma:*</label>
                <div class="col-sm-2">
            ...
            <div class="col-md-12" style="padding-top: 15px;">
              <div class="form-group">
                  ...
                  <label for="txtmodalidadObtencion" class="col-sm-2 control-label">Modalidad de Obtención:</label>
                  <div class="col-sm-10">
              ...
              <div class="col-md-12" style="padding-top: 15px;">
                <div class="form-group">
                    ...
                    <label for="txtnumresol" class="col-sm-2 control-label">N° de Resolución de Grado:</label>
                    <div class="col-sm-3">
                    ...
                    <label for="txtfecharesol" class="col-sm-2 control-label">Fecha de Resolución:*</label>
                    <div class="col-sm-2">
                    ...
                    <label for="txtnumdiploma" class="col-sm-1 control-label">N° de Diploma:</label>
                      <div class="col-sm-2">
                ...
                <div class="col-md-12" style="padding-top: 15px;">
                  <div class="form-group">
                      ...
                      <label for="txtautoridad" class="col-sm-2 control-label">Nombre del Rector:*</label>
                      <div class="col-sm-10">
                  ...
                  <div class="col-md-12" style="padding-top: 15px;">
                    <div class="form-group">
                        ...
                        <label for="txtfechaemision" class="col-sm-2 control-label">Fecha de Emisión del Grado:*</label>
                        <div class="col-sm-2">
