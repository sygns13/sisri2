<div class="box box-primary panel-group">
        <div class="box-header with-border" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
          <h3 class="box-title">Gestión de Alumnos Egresados de Postgrado</h3>
            ...
            <label for="cbusemestre" class="col-sm-1 control-label" style="width: auto;">Semestre de Matrícula:*</label>
                ...
                <div class="col-sm-12" style="padding-top:15px;">
                  ...
                  <div class="col-sm-12" style="padding-top:15px;">
                      ...
                      <a download="Instructivo_Carga_Data_Egresados_Postgrado.xlsx" type="button" class="btn btn-info" id="btnDescargarPlantilla" href="{{URL::to('instructivo/Instructivo_Carga_Data_Egresados_Postgrado.xlsx')}}" data-placement="top" data-toggle="tooltip" title="Descargar Instructivo Para Importar Data"><i class="fa fa-search" aria-hidden="true" ></i> Ver Instructivo Para Carga de Data</a>
...
<div class="box box-success" v-if="divNuevoImporte">
  <div class="box-header with-border" >
    <h3 class="box-title" id="tituloAgregarImporte">Importar Datos en Lote Alumnos Egresados de Postgrado - Formato EXCEL</h3>
  </div>
...
<div class="box box-success" v-if="divNuevo">
  ...
  @include('alumnosegresadospostgrado.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('alumnosegresadospostgrado.editar')  
      ...
      <div class="box box-primary" style="border: 1px solid #3c8dbc;" v-if="semestre_id!='0'">
        ...
        <h3 class="box-title">Listado de Alumnos Egresados en el Semestre: @{{semestreNombre}}</h3>
        ...
        <div class="box-body table-responsive">
          <table class="table table-hover table-bordered table-dark table-condensed table-striped" >
            <tbody><tr>
                ...
                <th style="font-size: 11px;border:1px solid #ddd;padding: 5px; width: 12%;">Grado de Egreso</th>
